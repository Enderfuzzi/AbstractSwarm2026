...
public class Network {
    ...
    private void init() {
        MultiLayerConfiguration config = new NeuralNetConfiguration.Builder()
                ...
                .layer(new OutputLayer.Builder(LossFunctions.LossFunction.MSE)
                        .nOut(1)
                        .activation(Activation.IDENTITY) // Erlaubt freie Skalierung der Utility
                        .build())
                .build();
    ...
    private final static double EPSILON_START = 0.9;
    private final static double EPSILON_DECAY = 1.0;
    private static final Random RANDOM = new Random();


    public double predict(Agent agent, double[] inputData) {
    ...
    public void train(Agent agent, double reward) {
